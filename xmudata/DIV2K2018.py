...
class DIV2K2018(Data):
    ...
    def __init__(self, train_truth_dir, train_data_dir, test_truth_dir = None, test_data_dir=None, image_size = 96, scale = 4, train_postfix_len = 3, test_postfix_len = -1, test_per = 0.2):
