    ...
    def get_test_set(self,batch_size):
        ...
        if self.test_index<self.test_size :
            ...
            if self.test_index + batch_size - 1 <= self.test_size:
                ...
                return self.get_image_set(self.test_set[index:index + batch_size],self.test_data_dir, self.test_truth_dir, self.test_postfix_len)
            else:
                self.test_index = self.test_size + 1
                return self.get_image_set(self.test_set[index:], self.test_data_dir, self.test_truth_dir, self.test_postfix_len)
        else:
            return None,None
